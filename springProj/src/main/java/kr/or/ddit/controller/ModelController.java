...
public class ModelController {
	...
	public String read01(Model model) {
		model.addAttribute("userId", "suin");
		model.addAttribute("password", "suin");
	...
	//2-2) Model 객체에 자바빈즈 클래스 객체(MemberVO) 객체(memberVO)를 값으로만 전달 시
	...
	요청파라미터 : {userId=suin,password=suin}
	요청방식 : post
	*/
