...
$(function(){
	$("#selSize").on("change",function(){
		let val = $(this).val();
		console.log("val : " + val);
		// /bookInfo/listBook?currentPage=5&size=10
...
<div class="card shadow mb-4">
	...
	<div class="card-body">
		<div class="table-responsive">
			...
			<!-- action="/bookInfo/listBook" method="get"는 현재 url이기 때문에 생략해도 됨 -->
			<!-- 
				...
				<div class="row">
					...
					<div class="col-sm-12 col-md-6">
						<div id="dataTable_filter" class="dataTables_filter">
							...
							<label>
								<!-- submit / button / reset -->
								<button type="submit" class="btn btn-primary btn-icon-split btn-icon-sm">
						...
						<table class="table table-bordered dataTable" id="dataTable"
							...
							<thead>
								<tr role="row">
									...
									<th class="sorting" tabindex="0" aria-controls="dataTable"
										rowspan="1" colspan="1"
										aria-label="저장: activate to sort column ascending"
										style="width: 10%;">저장</th>
									<th class="sorting" tabindex="0" aria-controls="dataTable"
										rowspan="1" colspan="1"
										aria-label="출판사: activate to sort column ascending"
										style="width: 10%;">출판사</th>
									<th class="sorting" tabindex="0" aria-controls="dataTable"
										rowspan="1" colspan="1"
				...
				<div class="row">
					<div class="col-sm-12 col-md-5">
						...
						<div class="dataTables_info" id="dataTable_info" role="status"
							aria-live="polite">Showing ${(data.currentPage * data.size) - (data.size - 1)}
