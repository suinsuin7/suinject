...
public class SusuController {
	...
	//1개 조회
	@ResponseBody
	@GetMapping(value =  "/suin/{title}", produces = "application/json;charset=utf-8")
	...
	// 1개 insert
	@ResponseBody
	@PostMapping(value =  "/suin", produces = "application/json;charset=utf-8")
	...
	// 1개 수정
	@ResponseBody
	@PutMapping(value =  "/suin", produces = "application/json;charset=utf-8")
	...
	// 1개 삭제
	@ResponseBody
	@DeleteMapping(value = "/suin/{title}", produces = "application/json;charset=utf-8")
